                ...
                Row(
                  children: [
                    TextButton(onPressed: () {
                      context.read<CounterBloc>().add(DecrementEvent(value : _controller.text));
                    }, child: const Text("-")),
                    TextButton(onPressed: () {
                      context.read<CounterBloc>().add(IncrementEvent(value :_controller.text));
                    }, child: const Text("+")),
                  ],
                ),
              ],
  ...
  CounterBloc() : super(const CounterStateValid(0)) {
    on<IncrementEvent>((event, emit) {
      ...
      if (interger == null) {
        ...
        emit(CounterStateValid(interger + state.value));
      }
    });
